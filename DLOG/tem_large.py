...
class TEM:
    ...
    def hb_attr(self, input_dir):
        self.hb_attracttion_model = self.tem_model.HBAttractionModel(
            ...
            emp_landuse_paths = {2024: input_dir / "dlog_soc_sic_emp_2024_large.dvec",
                                 2025: input_dir / "dlog_soc_sic_emp_2025_large.dvec",
                                 2035: input_dir / "dlog_soc_sic_emp_2035_large.dvec",
                                 2045: input_dir / "dlog_soc_sic_emp_2045_large.dvec"}, 
            hh_landuse_dirs = {2024: input_dir / "dlog_hh_2024_large.dvec",
                               2025: input_dir / "dlog_hh_2025_large.dvec",
                               2035: input_dir / "dlog_hh_2035_large.dvec",
                               2045: input_dir / "dlog_hh_2045_large.dvec"}, 
...
class TEMProcessing:
    ...
    def process_output(self):
        ...
        combined_file_path = os.path.join(self.export_home, "nhb_normits_tem_segmented_large.csv.bz2")
