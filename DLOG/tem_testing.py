...
HBProd = model.HBProductionModel(
    population_paths={2023: Path(r"T:\Yan_Kavana\tem_inputs_isaac\landuse\pop.dvec")}, #provide
...
emp = Landuse(land_use=r"T:\Yan_Kavana\tem_inputs_isaac\landuse\emp.dvec", # provide
        type='emp',
