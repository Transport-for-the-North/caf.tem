...
prod_fr = cb.DVector.load(
    Path(r"C:\Users\YanZhu\caf_tem\Outputs\post_me_adj_7\Core\hb_productions\hb_normits_tem_segmented_fr_2023.dvec")
)
prod_to = cb.DVector.load(
    Path(r"C:\Users\YanZhu\caf_tem\Outputs\post_me_adj_7\Core\hb_productions\hb_normits_tem_segmented_to_2023.dvec")
)
attr_fr = cb.DVector.load(
    Path(r"C:\Users\YanZhu\caf_tem\Outputs\post_me_adj_7\Core\hb_attractions\hb_normits_tem_segmented_fr_2023.dvec")
)
attr_to = cb.DVector.load(
    Path(r"C:\Users\YanZhu\caf_tem\Outputs\post_me_adj_7\Core\hb_attractions\hb_normits_tem_segmented_to_2023.dvec")
)
nhb_prod = cb.DVector.load(
    Path(r"C:\Users\YanZhu\caf_tem\Outputs\post_me_adj_7\Core\nhb_productions\nhb_normits_tem_segmented_fr_2023.dvec")
)
...
pm_prod_fr = cb.DVector.load(
    Path(r"C:\Users\YanZhu\caf_tem\Outputs\post_me_adj_7\Core\hb_productions\hb_normits_tem_segmented_fr_pm_2023.dvec")
)
pm_prod_to = cb.DVector.load(
    Path(r"C:\Users\YanZhu\caf_tem\Outputs\post_me_adj_7\Core\hb_productions\hb_normits_tem_segmented_to_pm_2023.dvec")
)
pm_attr_fr = cb.DVector.load(
    Path(r"C:\Users\YanZhu\caf_tem\Outputs\post_me_adj_7\Core\hb_attractions\hb_normits_tem_segmented_fr_pm_2023.dvec")
)
pm_attr_to = cb.DVector.load(
    Path(r"C:\Users\YanZhu\caf_tem\Outputs\post_me_adj_7\Core\hb_attractions\hb_normits_tem_segmented_to_pm_2023.dvec")
)
