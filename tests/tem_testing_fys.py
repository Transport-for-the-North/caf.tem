...
for year in model_years:
    if year == 2023:
        population_paths[year] = Path(r"T:\Yan_Kavana\tem_inputs_isaac\landuse\pop.dvec")
    else:
        population_paths[year] = Path(
            fr"I:\Data\D-Log\DLIT\Outputs\test20_v0.19_updated\M4_split\dvec_pop\pop_{year}.dvec"
        )
...
for year in model_years:
    emp_path = (
        ...
        fr"I:\Data\D-Log\DLIT\Outputs\test20_v0.19_updated\M4_split\dvec_emp\emp_{year}.dvec"
    )
    hh_obj = (
        Landuse(
            type='pop',
            land_use=r"T:\Yan_Kavana\tem_inputs_isaac\landuse",
        ...
        Landuse(
            type='pop',
            land_use=fr"I:\Data\D-Log\DLIT\Outputs\test20_v0.19_updated\M4_split\dvec_hh\hh_{year}.dvec",
