...
emp_2025 = Landuse(
    land_use=r"I:\Data\D-Log\DLIT\Outputs\test20_v0.19_updated\M4_split\dvec_emp\emp_large_2025.dvec",  # provide
    type="emp",
    segmentation=["soc", "sic_1_digit", "sic_2_digit"],
    out_zoning=[model.output_zoning, model.agg_zoning, "uni", gor],
    trans_tag="uni",
...
#         trans_tag='uni')
hh_2025 = Landuse(
    land_use=r"I:\Data\D-Log\DLIT\Outputs\test20_v0.19_updated\M4_split\dvec_hh\hh_large_2025.dvec",  # provide
    type="pop",
    segmentation=[
        "accom_h",
        "ns_sec",
